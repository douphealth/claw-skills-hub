  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      <div className="absolute inset-0">
        <img src={heroBg} alt="OpenClaw AI agent skills directory — abstract technology background representing AI automation and developer workflows" className="w-full h-full object-cover opacity-40" loading="lazy" decoding="async" />
